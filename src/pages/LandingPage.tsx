...
export default function LandingPage() {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section 
        className="relative min-h-[90vh] flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 text-center bg-cover bg-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl space-y-8">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-white/90 font-medium">
            Florianópolis e Taíba | Aulas desde R$ 400
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            ...
            <Button 
              ...
              className="text-lg px-8 py-6 bg-white/10 backdrop-blur-sm text-white border-white hover:bg-white hover:text-primary transition-all"
            >
              Falar no WhatsApp
            </Button>
          </div>
