  ...
  inicializarMockCompleto: () => {
    ...
    if (!localStorage.getItem(EQUIPAMENTOS_KEY)) {
      const mockEquipamentos: Equipamento[] = [
        // KITES DUOTONE
        { id: 'EQ001', nome: 'Kite Duotone Neo SLS 2026', tipo: 'kite', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 350, preco_venda: 12429, tamanho: '9m', marca: 'Duotone', modelo: 'Neo SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1559310278-18a9192d909f?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ002', nome: 'Kite Duotone Neo SLS 2026', tipo: 'kite', status: 'alugado', localizacao: 'florianopolis', preco_dia: 350, preco_venda: 12429, tamanho: '12m', marca: 'Duotone', modelo: 'Neo SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1559310278-18a9192d909f?w=400&h=300&fit=crop', ultimo_aluguel: new Date().toISOString(), created_at: new Date().toISOString() },
        { id: 'EQ003', nome: 'Kite Duotone Dice SLS 2026', tipo: 'kite', status: 'disponivel', localizacao: 'taiba', preco_dia: 380, preco_venda: 13029, tamanho: '10m', marca: 'Duotone', modelo: 'Dice SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1601024445121-e5c6a2b31f28?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ004', nome: 'Kite Duotone Rebel SLS 2026', tipo: 'kite', status: 'alugado', localizacao: 'taiba', preco_dia: 380, preco_venda: 13029, tamanho: '11m', marca: 'Duotone', modelo: 'Rebel SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1559310278-18a9192d909f?w=400&h=300&fit=crop', ultimo_aluguel: new Date(Date.now() - 172800000).toISOString(), created_at: new Date().toISOString() },
        { id: 'EQ005', nome: 'Kite Duotone Evo SLS 2025', tipo: 'kite', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 320, preco_venda: 10999, tamanho: '8m', marca: 'Duotone', modelo: 'Evo SLS', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1601024445121-e5c6a2b31f28?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // WINGS DUOTONE
        { id: 'EQ006', nome: 'Wing Duotone Unit SLS 2026', tipo: 'wing', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 250, preco_venda: 8589, tamanho: '5m', marca: 'Duotone', modelo: 'Unit SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ007', nome: 'Wing Duotone Unit SLS 2026', tipo: 'wing', status: 'alugado', localizacao: 'taiba', preco_dia: 250, preco_venda: 8589, tamanho: '4m', marca: 'Duotone', modelo: 'Unit SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=400&h=300&fit=crop', ultimo_aluguel: new Date().toISOString(), created_at: new Date().toISOString() },
        { id: 'EQ008', nome: 'Wing Duotone Unit 2025', tipo: 'wing', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 200, preco_venda: 6299, tamanho: '6m', marca: 'Duotone', modelo: 'Unit', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // BARRAS DUOTONE
        { id: 'EQ009', nome: 'Barra Duotone ClickBar Quad Control', tipo: 'barra', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 100, preco_venda: 5859, tamanho: 'M/22-24', marca: 'Duotone', modelo: 'ClickBar', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ010', nome: 'Barra Duotone Trust Bar Quad Control', tipo: 'barra', status: 'disponivel', localizacao: 'taiba', preco_dia: 80, preco_venda: 4299, tamanho: 'M/22-24', marca: 'Duotone', modelo: 'Trust Bar', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // PRANCHAS TWINTIP
        { id: 'EQ011', nome: 'Prancha Duotone Select 2026', tipo: 'prancha_twintip', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 150, preco_venda: 3899, tamanho: '140cm', marca: 'Duotone', modelo: 'Select', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1509914398892-963f53e6e2f1?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ012', nome: 'Prancha Duotone Jaime 2025', tipo: 'prancha_twintip', status: 'alugado', localizacao: 'taiba', preco_dia: 180, preco_venda: 4599, tamanho: '138cm', marca: 'Duotone', modelo: 'Jaime', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1509914398892-963f53e6e2f1?w=400&h=300&fit=crop', ultimo_aluguel: new Date().toISOString(), created_at: new Date().toISOString() },
        { id: 'EQ013', nome: 'Prancha Duotone Soleil 2026', tipo: 'prancha_twintip', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 150, preco_venda: 3699, tamanho: '136cm', marca: 'Duotone', modelo: 'Soleil', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1509914398892-963f53e6e2f1?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // PRANCHAS KITEWAVE/SURFBOARD
        { id: 'EQ014', nome: 'Prancha Duotone Whip SLS 2026', tipo: 'prancha_kitewave', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 200, preco_venda: 5299, tamanho: '5\'4"', marca: 'Duotone', modelo: 'Whip SLS', ano: 2026, foto_url: 'https://images.unsplash.com/photo-1531722569936-825d3dd91b15?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ015', nome: 'Prancha Duotone Fish SLS 2025', tipo: 'prancha_kitewave', status: 'disponivel', localizacao: 'taiba', preco_dia: 180, preco_venda: 4799, tamanho: '5\'8"', marca: 'Duotone', modelo: 'Fish SLS', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1531722569936-825d3dd91b15?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // TRAPÉZIOS
        { id: 'EQ016', nome: 'Trapézio Mystic Majestic X 2025', tipo: 'trapezio', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 60, preco_venda: 1899, tamanho: 'L', marca: 'Mystic', modelo: 'Majestic X', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ017', nome: 'Trapézio Mystic Majestic X 2025', tipo: 'trapezio', status: 'manutencao', localizacao: 'florianopolis', preco_dia: 60, preco_venda: 1899, tamanho: 'M', marca: 'Mystic', modelo: 'Majestic X', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ018', nome: 'Trapézio Ion Apex Curv 15', tipo: 'trapezio', status: 'disponivel', localizacao: 'taiba', preco_dia: 50, preco_venda: 1599, tamanho: 'M', marca: 'Ion', modelo: 'Apex Curv 15', ano: 2024, foto_url: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        
        // WETSUITS
        { id: 'EQ019', nome: 'Wetsuit Mystic Star 5/4mm', tipo: 'wetsuit', status: 'disponivel', localizacao: 'florianopolis', preco_dia: 40, preco_venda: 899, tamanho: 'L', marca: 'Mystic', modelo: 'Star 5/4mm', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
        { id: 'EQ020', nome: 'Wetsuit Mystic Star 3/2mm', tipo: 'wetsuit', status: 'disponivel', localizacao: 'taiba', preco_dia: 35, preco_venda: 699, tamanho: 'M', marca: 'Mystic', modelo: 'Star 3/2mm', ano: 2025, foto_url: 'https://images.unsplash.com/photo-1519046904884-53103b34b206?w=400&h=300&fit=crop', created_at: new Date().toISOString() },
      ];
