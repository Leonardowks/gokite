  ...
  return (
    <div className="h-full flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <div className="px-4 py-3 border-b bg-card/80 backdrop-blur-sm shrink-0">
        ...
        {/* Input de mensagem */}
        <div className="p-3 border-t bg-card/80 backdrop-blur-sm space-y-2 shrink-0">
          {/* Preview do arquivo */}
          {arquivoSelecionado && (
      ...
      {/* Painel de Contexto Comercial (lateral direita) */}
      {showContextPanel && (
        <div className="w-72 shrink-0 hidden lg:block border-l">
          <ChatContextPanel
            contato={contato}
