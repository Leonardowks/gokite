      ...
      <div className="min-h-screen flex flex-col w-full bg-ocean-pattern">
        ...
        <header className="sticky top-0 z-40 glass-premium border-b border-primary/10">
          <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3">
            {/* Left: Prominent Hamburger Menu + Logo */}
            <div className="flex items-center gap-4">
              <SidebarTrigger className="min-h-[48px] min-w-[48px] rounded-xl bg-gradient-to-br from-primary to-cyan text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center">
                <Menu className="h-6 w-6" />
              </SidebarTrigger>
              
              {/* Logo with ocean glow */}
