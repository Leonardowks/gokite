  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-md hover:shadow-lg hover:brightness-110",
        ocean: "bg-gradient-to-r from-primary via-[hsl(195,85%,40%)] to-cyan text-white shadow-ocean hover:shadow-lg hover:-translate-y-0.5 border-0",
        sunset: "bg-gradient-to-r from-accent via-[hsl(15,90%,50%)] to-[hsl(350,85%,50%)] text-white shadow-glow-accent hover:shadow-lg hover:-translate-y-0.5 border-0",
      },
      size: {
